...
public class Day22
{
    ...
    public class Puzzle
    {
        ...
        private (bool can, Point next) GetNextPosPart2()
        {
            ...
            var next = _pos + _direction;
            if (At(next) == ' ') throw new Exception();
            return (At(next) == '.', next);
        }
